...
export default function LandingPage({ onGoToRegistration, onGoToAdmin }: LandingPageProps) {
  ...
  const modalities = [
    { name: 'Corrida Longa 5km', cat: 'corrida', age: 'Livre', icon: '🏃', tag: 'open' },
    { name: 'Caminhada 2,5km', cat: 'livre', age: 'Livre', icon: '🚶', tag: 'open' },
    { name: 'Corrida Curta Adulta', cat: 'corrida', age: '14+ anos', icon: '⚡', tag: 'member', sub: '100m · 150m · 200m' },
    { name: 'Corrida Curta Pré-Teens', cat: 'corrida', age: '10–13 anos', icon: '⚡', tag: 'member', sub: '100m · 150m' },
    { name: 'Corrida Curta Kids', cat: 'kids', age: '3–9 anos', icon: '⚡', tag: 'member', sub: '10m · 20m · 30m' },
    { name: 'Futsal', cat: 'coletivo', age: '14+ anos', icon: '⚽', tag: 'member' },
    { name: 'Futsal Pré-Teens', cat: 'coletivo', age: '10–13 anos', icon: '⚽', tag: 'member' },
    { name: 'Vôlei de Quadra', cat: 'coletivo', age: '14+ anos', icon: '🏐', tag: 'member' },
    { name: 'Queimada', cat: 'coletivo', age: '11+ anos', icon: '🔥', tag: 'member' },
    { name: 'Basquete', cat: 'coletivo', age: '14+ anos', icon: '🏀', tag: 'member' },
    { name: 'Natação', cat: 'livre', age: '9+ anos', icon: '🏊', tag: 'member' },
    { name: 'Tênis de Mesa', cat: 'livre', age: '9+ anos', icon: '🏓', tag: 'member' },
    { name: 'Circuito Adulto', cat: 'corrida', age: '14+ anos', icon: '🏋️', tag: 'member', sub: 'Obstáculos' },
    { name: 'Circuito Kids', cat: 'kids', age: '8–13 anos', icon: '🏋️', tag: 'member', sub: 'Obstáculos' },
    { name: 'E-Sports FIFA', cat: 'esports', age: '9+ anos', icon: '🎮', tag: 'member' },
    { name: 'E-Sports CS', cat: 'esports', age: '9+ anos', icon: '🎮', tag: 'member', sub: 'Counter-Strike' },
    { name: 'E-Sports LoL', cat: 'esports', age: '9+ anos', icon: '🎮', tag: 'member', sub: 'League of Legends' },
    { name: 'Treino Funcional', cat: 'livre', age: 'Livre', icon: '💪', tag: 'open', sub: 'Não competitivo' },
  ];
